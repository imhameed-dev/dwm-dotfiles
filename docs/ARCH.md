...
Core packages include Xorg/Xinit, libinput, X11 utilities, Polybar, Picom, Rofi, Alacritty, Dunst, Feh, Firefox, Thunar, NetworkManager, `network-manager-applet`, `brightnessctl`, i3lock, and JetBrains Mono.
